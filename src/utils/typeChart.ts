...
export const getDefensiveMultiplier = (attackingType: string, defendingTypes: string[]): number => {
  let multiplier = 1;
  const attackRelations = typeChart[attackingType] || {};
...
export const checkStab = (moveType: string, pokemonTypes: string[]): boolean => {
